...
<h3 className='text-red-500 font-semibold font-sans text-sm'>Powerig Your World Whit the Best in Electronics </h3>
...
<button className='bg-gradient-to-r from-red-500 to-purple-500 text-white px-3 rounded-md cursor-pointer mt-2'>Shop Now</button>
              </div>
              <div>
                <img src={item.images} alt={item.title} className='rounded-full w-[500px]  hover:scale-105 transition-all shadow-2xl shadow-red-400' />
              </div>
              </div>
          </div>
        })
